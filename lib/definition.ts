 ...
 * @typicalname option
 */
export class OptionDefinitionInstance<T> implements OptionDefinition<T> {
    name: string;
    type?: (value : string) => T;
    alias?: string;
    multiple?: boolean;
    ...
    constructor(definition : OptionDefinition<T>) {
        /**
    ...
    * }
         ...
         * @default String
         */
        this.type = definition.type || <any> String;
    ...
    *}
        ...
        for (let prop in definition) {
            if (!(<any> this)[prop]) {
                (<any> this)[prop] = (<any> definition)[prop];
            }
        }
    }
    ...
    isBoolean(value : any) {
        if (this.type) {
            return (<any> this.type) === Boolean || (typeof this.type === 'function' && this.type.name === 'Boolean');
        } else {
            return false;
        }
    }
